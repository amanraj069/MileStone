...
function loadSavedProfileData() {
    ...
    if (savedProfile) {
        ...
        setInputValue('picture', profileData.picture || 'https://via.placeholder.com/150');
        ...
        setInputValue('picture', 'https://via.placeholder.com/150');
    }
}
...
function saveProfileData() {
    const profileData = {
        ...
        picture: getInputValue('picture') || 'https://via.placeholder.com/150',
